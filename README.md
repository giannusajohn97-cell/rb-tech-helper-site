...
## Update 2 edits
- Made the header logo much larger and easier to read
- Removed the icon next to "Technology should not feel stressful"
- Removed the icon next to "Who This Service Is For"
- Added a second image to the "Why People Call Me" section using the newly supplied image
- Enlarged the logos on both sides of the "Proudly Serving" section and used the full horizontal logo file


## Final revision
- Kept Image 4 next to the "Why People Call Me" section
- Moved the other service image down into the "Who This Service Is For" section
- Enlarged and spread out the two Proudly Serving logos
- Brought back the location icon in the Proudly Serving section
